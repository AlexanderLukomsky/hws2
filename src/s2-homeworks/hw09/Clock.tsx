...
function Clock() {
  ...
  const engDateDayFormatter = new Intl.DateTimeFormat("eng", {
    weekday: "long",
  });
  const engDateMonthFormatter = new Intl.DateTimeFormat("eng", {
    month: "long",
  });
  ...
  const stringDay = engDateDayFormatter.format(date);
  const stringMonth = engDateMonthFormatter.format(date); // пишут студенты
